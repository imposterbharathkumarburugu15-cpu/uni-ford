...
export function EvidenceViewer({
  ...
  const [prevParams, setPrevParams] = useState({ attributeKey, productId });

  if (prevParams.attributeKey !== attributeKey || prevParams.productId !== productId) {
    setPrevParams({ attributeKey, productId });
